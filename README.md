...
MeetingMind  A serverless AI-powered productivity tool that turns messy meeting transcripts into structured key points and prioritized action items
# MeetingMind
...
3. Connect your fork — no build settings needed, it's a static site.
